...
const projects = [
  {
    ...
    description: "A beautiful landing page React and Tailwind.",
  ...
  return (
    ...
    <div
        ...
        >
          ...
          <div className="p-6">
            <div className="flex flex-wrap gap-2 mb-4">
                 {project.tag?.map((tag) => (
                  <span key={tag}                 
                  className="px-2 py-1 text-xs font-medium border rounded-full  bg-primary text-secondary text-secondary-foreground">
                  {tag}
                  </span>
                 ))}         
            </div>
     ...
     <div className="text-center mt-12">
      ...
      target="_blank"
      href="https://github.com/anupprajapati"
      >
